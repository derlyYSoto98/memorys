...
<head>
  ...
  <link rel="stylesheet" href="../../css/eliminar1.css"> 
                ...
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu"> 
                        <li><a href="consultar_variedad.php">Consultar Variedad</a></li>
                        <li><a href="actualizar_variedad.php">Actualizar Variedad</a></li>
                        <li><a href="eliminar_variedad.php"> Eliminar Variedad</a></li>
                        <li><a href="busqueda_variedad.php">Buscar Variedad</a></li>
                      </ul>
                    </li>
                    <li>
      ...
      <div class="container">
        ...
        <table>
         <tr>
             ...
             <?php
                    try {
                        $sql="SELECT * FROM variedad WHERE id_variedad=".$_REQUEST['cod1'].";";
                        $resultado=$cadena->prepare($sql);
                        $resultado-> execute(array());
                        while($consulta=$resultado-> fetch (PDO:: FETCH_ASSOC)){
                            echo "<h1>Alerta!!!! esta seguro que decea eliminar la variedad  <span class='titulo1'>".$consulta['nombre_variedad']. " </span> de la base de datos.</h1>";
                        }
                    } catch (Exception $e) {
         ...
         <table class="simbolos" >
                <tr>
                    <td><a href="eliminar_variedad2.php?cod2=<?php echo $_REQUEST['cod1']?>"><i class="fa-solid fa-check-to-slot icono"></i></a> </td>
                    <td><a href="eliminar_variedad.php"><i class="fa-solid fa-rectangle-xmark icono"></i></a> </td>
                </tr>
         </table>
