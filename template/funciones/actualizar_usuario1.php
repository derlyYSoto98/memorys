      ...
      <div class="container">
        ...
        <?php
         try {
             ...
             ?>
                <form  name="form" action="actualizar_usuario2.php?id=<?php echo $_REQUEST['cod'];?> " method="POST" enctype="multipart/form-data" class="formprincipal">
                <td> <h3> Actualizando informacion del Usuario <span class="usuario"> <?php echo $consulta['nombre_usuario']; ?></span></h3> </td > 
                     <table >
                     <tr>
                        <th >Fotografia de referencia:   </th>
                        <th > <img src="../fotografiaUsuario/<?=$consulta['foto_usuario']?>" alt="" width="100px"> <input type="text" name="imagenantigua" value="<?php echo $consulta['foto_usuario']; ?>" readonly > </th>
                     </tr>
                     <tr>
                     ...
                     <tr>
                         <td class="boton" > <input type="submit" name="buton" value="Actualizar..." class="btn btn-danger" ></td>
