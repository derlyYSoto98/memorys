  ...
  <div id="wrapper">
   ...
   <!--  <section id="intro">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
        <h1 class="primertitulo2">ACTUALIZAR PROCESO REGISTRADO</h1>
                  ...
                  try {
                      ...
                      while ($consulta = $resultado -> fetch (PDO:: FETCH_ASSOC)){
                       ...
                       <tr>
                           ...
                           <td><a class="editar" href="actualizar_proceso1.php?cod=<?php echo $consulta ['id_proceso']?>"><i class="fa-solid fa-pen-to-square"></i>Editar</a></td> 
                        </tr> 
                       <?php 
                      }
                  } catch (Exception $e) {
