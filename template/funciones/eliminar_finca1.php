        ...
        <table>
         <tr>
             <td>
               <?php
                    try {
                        $sql="SELECT * FROM finca WHERE id_finca=".$_REQUEST['cod1'].";";
                        $resultado=$cadena->prepare($sql);
                        $resultado-> execute(array());
                        while($consulta=$resultado-> fetch (PDO:: FETCH_ASSOC)){
                            echo "<h1>Alerta!!!! esta seguro que decea eliminar la finca  <span class='titulo1'>".$consulta['nombre_finca']. " </span> de la base de datos.</h1>";
                        }
                    } catch (Exception $e) {
         ...
         <table class="simbolos" >
                <tr>
                    <td><a href="eliminar_finca2.php?cod2=<?php echo $_REQUEST['cod1']?>"><i class="fa-solid fa-check-to-slot icono"></i></a> </td>
                    <td><a href="eliminar_fincas.php"><i class="fa-solid fa-rectangle-xmark icono"></i></a> </td>
                </tr>
         </table>
