...
<head>
  <meta charset="utf-8">
  <title>Memorys Café / Actualizando variedad</title>
                ...
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="consultar_fincas.php">Consultar Fincas</a></li>
                        <li><a href="actualizar_fincas.php">Actualizar Fincas</a></li>
                        <li><a href="eliminar_fincas.php"> Eliminar Finca</a></li>
                        <li><a href="busqueda_fincas.php">Buscar Finca</a></li>
                      </ul>
                    </li>
                    <li>
      ...
      <div class="container">
        ...
        <?php
         try {
             ...
             ?>
                <form  name="form" action="actualizar_variedad2.php?id=<?php echo $_REQUEST['cod'];?> " method="POST" enctype="multipart/form-data" class="formprincipal">
                <td> <h3> Actualizando informacion de la variedad  <span  <span class="usuario"> <?php echo $consulta['nombre_variedad']; ?></span></h3> </td>

                     <table >
                     <tr>
                        <th >Fotografia de referencia:   </th>
                        <th > <img src="../fotografiaVariedad/<?=$consulta['foto_variedad']?>" alt="" width="100px"> <input type="text" name="imagenantigua" value="<?php echo $consulta['foto_variedad']; ?>" readonly > </th>
                     </tr>
                     <tr>
                     ...
                     <tr>
                         <td class="boton" ><input type="submit" name="butonv" value="Actualizar..." class="btn btn-danger" ></td>
