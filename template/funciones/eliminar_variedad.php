  ...
  <div id="wrapper">
   ...
   <!--  <section id="intro">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
        <h1 class="primertitulo2">ELIMINAR VARIEDAD REGISTRADA</h1>
                  ...
                  try {
                      ...
                      while ($consulta = $resultado -> fetch (PDO:: FETCH_ASSOC)){
                       ...
                       <tr>
                           ...
                           <th><a class="eliminar" href="eliminar_variedad1.php?cod1=<?php echo $consulta ['id_variedad']?>"><i class="fa-solid fa-trash-can"></i>Eliminar</a></th> 
                        </tr> 
                       <?php 
                      }
                  } catch (Exception $e) {
