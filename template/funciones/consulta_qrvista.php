      ...
      <div class="container">
        <div class="row">
            <div class="titulo principal">
                <h2>QR</h2>
                <h5>Seleccione los datos para generar la vista del codigo qr</h5>
            </div>
            <legend>Informacion del proceso</legend>
                        ...
                        <form class="form-horizontal" method="GET" id="codeForm" action="consulta_qr2.php">
                              <div class="form-group">
                                  <label>Proceso:</label>
                              ...
                              <div class="form-group">
                              <input type="submit" name="proceso" id="submit" class="btn btn-success" value="Generar vista QR">
                          </div>   
                 </form> 
                <!--  <div class="col-md-6">
