...
<head>
  <meta charset="utf-8">
  <title>Memorys Café / Busqueda de Finca</title>
   ...
   <!--  <section id="intro">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
        <div class="titulo">
    <h2>Buscar Finca Registrada</h2>
    <h5>La busqueda se genera por el nombre de finca</h5>
</div>
    ...
    $busqueda=$_POST['txtbuscar']; /* echo $busqueda; */
        ...
        ?>
           <table class="table table-striped-columns principal" width="700px">
             <tr>
                 <td class="box1"> Nombre de la finca</td>
                 <td class="box1">Ubicacion</td>
                 <td class="box1">Altitud</td>
                 <td class="box1">Fotografia de referencia</td>
                
             </tr>
        <?php
        try {
            $sql="SELECT * FROM finca WHERE nombre_finca =?";
            ...
            if ($contador >= 1) {
                ...
                ?>
                   <tr>
                       ...
                       <th><a href="actualizar_finca1.php?cod=<?php echo $consulta ['id_finca']?>"><i class="fa-solid fa-pen-to-square"></i>Editar</a></th>
                       <th><a href="eliminar_finca1.php?cod1=<?php echo $consulta ['id_finca']?>"><i class="fa-solid fa-trash-can"></i>Eliminar</a></th>
                   </tr>
                 <?php
                }
               }else{
