      ...
      <div class="container">
        ...
        <?php
         try {
             ...
             ?>
                <form  name="form" action="actualizar_finca2.php?id=<?php echo $_REQUEST['cod'];?> " method="POST" enctype="multipart/form-data" class="formprincipal">
                <td> <h3> Actualizando informacion de la finca  <span class="usuario"> <?php echo $consulta['nombre_finca']; ?></span></h3> </td > 
                     <table >
                     <tr>
                        <th >Fotografia de referencia:   </th>
                        <th > <img src="../fotografiaFinca/<?=$consulta['foto_finca']?>" alt="" width="50px" height="50px"> <input type="text" name="imagenantigua" value="<?php echo $consulta['foto_finca']?>" readonly > </th>
                     </tr>
                     <tr>
                     ...
                     <tr>
                         <td class="boton" > <input type="submit" name="butonf" value="Actualizar..." class="btn btn-danger" ></td>
