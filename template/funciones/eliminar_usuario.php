  ...
  <div id="wrapper">
   ...
   <!--  <section id="intro">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
        <h1 class="primertitulo2">ELIMINAR USUARIOS REGISTRADOS</h1>
                ...
                <?php
                        try {
                            ...
                            <tr>
                                ...
                                <td><a class="eliminar" href="eliminar_usuario1.php?cod1=<?php echo $consulta ['cedula_usuario']?>"><i class="fa-solid fa-trash-can"></i> Eliminar</a></td>
                              </tr> 
                            <?php 
                            }
                        } catch (Exception $e) {
