      ...
      <div class="containe">
        <div class="row">
            <div class="titulo principal">
                ...
                <h5>La consulta general le mostrara todos los datos asociados al numero de documento que digite</h5>
            </div>
              <form action="" method="POST" class="principal">
                <table class="tabla3" >
                  <tr>
                      <td><input type="text" name="txtdato" id="box"></td>
                      <td><button type="submit" value="Consultar..." name="btnpreguntar" class="btn btn-danger buscar">Consultar</button></td>
              ...
              <table class="table table-success table-striped principal">
                              <tr>
              ...
              if (isset($_POST['btnpreguntar'])) {
                ...
                try {
                    ...
                    <a href="../inicio.php" class="regresar">Volver</a>
        </div>
      </div>
    </section>
