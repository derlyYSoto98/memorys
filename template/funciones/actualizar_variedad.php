  ...
  <div id="wrapper">
   ...
   <!--  <section id="intro">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
        <h1 class="primertitulo2">ACTUALIZAR USUARIO REGISTRADO</h1>
                  ...
                  try {
                      ...
                      while ($consulta = $resultado -> fetch (PDO:: FETCH_ASSOC)){
                       ...
                       <tr>
                           ...
                           <th><a class="editar" href="actualizar_variedad1.php?cod=<?php echo $consulta ['id_variedad']?>"><i class="fa-solid fa-pen-to-square"></i>Editar</a></th>
                        </tr> 
                       <?php 
                      }
                  } catch (Exception $e) {
