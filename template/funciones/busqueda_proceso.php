...
<head>
  <meta charset="utf-8">
  <title>Memorys Café / Busqueda de proceso</title>
...
<body>
  <div id="wrapper">
   ...
   <!--  <section id="intro">
    ...
    <h5>La busqueda se genera por nombre del proceso</h5>
</div>
  <form action="" method="POST">
    <table class="tabla3" >
       <tr>
           <th><input type="text" name="txtbuscar" id="box"></th> 
           <th><button type="submit" value="Buscar..." name="btnbuscar" class="btn btn-danger buscar">Buscar..</button></th>
       </tr>
    </table>
  </form>
  ...
  <?php
    ...
    $busqueda=$_POST['txtbuscar']; /* echo $busqueda; */
        ...
        <table class="table table-striped-columns principal" width="700px">
             ...
             <?php
        try {
            $sql="SELECT * FROM proceso WHERE nombre_proceso =?";
                ...
                ?>
                   <tr>
                      <td class="box2"><img src="../fotografiaProceso/<?=$consulta['foto_proceso']?>" title="<?=$consulta['foto_proceso']?>" width="100" height="100"></td>
                       ...
                       <th><a href="actualizar_proceso1.php?cod=<?php echo $consulta ['id_proceso']?>"><i class="fa-solid fa-pen-to-square"></i>Editar</a></th>
                       <th><a href="eliminar_proceso1.php?cod1=<?php echo $consulta ['id_proceso']?>"><i class="fa-solid fa-trash-can"></i>Eliminar</a></th>
                   </tr>
                 <?php
                }
               }else{
  ...
  ?>
       ...
       <a href="../proceso.php" class="regresar">Volver</a>
