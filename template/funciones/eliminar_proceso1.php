      ...
      <div class="container">
        ...
        <table>
             ...
             <?php
                    try {
                        ...
                        while($consulta=$resultado-> fetch (PDO:: FETCH_ASSOC)){
                            echo "<h1>Alerta!!!! esta seguro que decea eliminar el proceso <span class='titulo1'>".$consulta['nombre_proceso']. " </span> de la base de datos.</h1>";
                        }
                    } catch (Exception $e) {
         ...
         <table class="simbolos" >
                <tr>
                    <td><a href="eliminar_proceso2.php?cod2=<?php echo $_REQUEST['cod1']?>"><i class="fa-solid fa-check-to-slot icono"></i></a> </td>
                    <td><a href="eliminar_procesos.php"><i class="fa-solid fa-rectangle-xmark icono"></i></a> </td>
                </tr>
         </table>
