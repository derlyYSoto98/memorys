...
<head>
  <meta charset="utf-8">
  <title>Memorys Café / Busqueda de variedad</title>
...
<body>
  <div id="wrapper">
   ...
   <!--  <section id="intro">
    ...
    <h5>La busqueda se genera por nombre de la variedad</h5>
</div>
        ...
        if ($contador >= 1) {
            ...
            ?>
               <tr>
                   ...
                   <th><a href="actualizar_variedad1.php?cod=<?php echo $consulta ['id_variedad']?>"><i class="fa-solid fa-pen-to-square"></i>Editar</a></th>
                   <th><a href="eliminar_variedad1.php?cod1=<?php echo $consulta ['id_variedad']?>"><i class="fa-solid fa-trash-can"></i>Eliminar</a></th>
               </tr>
             <?php
            }
           }else{
