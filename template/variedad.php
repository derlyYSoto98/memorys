  ...
  <div id="wrapper">
   ...
   <!--  <section id="intro">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
        <h1 class="tituliPrincipal">REGISTRO DE VARIEDAD</h1>
        <form action="" name="form1" method="POST" enctype="multipart/form-data" class="formulario_principal">
                    ...
                    <legend>Informacion de la Variedad</legend>
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label><i class="fa-solid fa-plant-wilt"></i> Nombre de la variedad:</label>
                                <input type="text" name="nomvar" id="nomfin" required class="form-control">
                            </div>
                            <div class="form-group">
                                <label><i class="fa-solid fa-align-justify"></i> Descripcion:</label>
