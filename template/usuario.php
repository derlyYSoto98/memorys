  ...
  <div id="wrapper">
   ...
   <!--  <section id="intro">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
        <h1 class="tituliPrincipal">REGISTRO DE USUARIO</h1>
   <form action="" name="form1" method="POST" enctype="multipart/form-data" class="formulario_principal">
                <fieldset>
                    <legend>Datos de usuario</legend> 
                        <div class="form-group">
                            <label><i class="fa-solid fa-id-card"></i> Numero de documento</label>
                        ...
                        <div class="form-group"> 
                            <label> <i class="fa-solid fa-location-dot"></i> Direccion de Residencia</label>
                            <input type="text" name="dirusu" id="dirusu" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label> <i class="fa-solid fa-phone"></i> Telefono de contacto</label>
                            <input type="text" name="telusu" id="telusu"  required class="form-control">
                        </div>
                        <div class="d-grid gap-2"> 
                            <label> <i class="fa-solid fa-image-polaroid"></i> Fotografia de Referencia</label>
